...
async function jedem() {
    ...
    while (!emergencyLatched) {
        ...
        if (canTurnLeft) {
            ...
            await driveArc(robutek, angleState, RADIUS_LEFT, 180, SPEED_ARC, EMERGENCY_BUTTON_PIN, leds, emergencyStop, () => emergencyLatched);
            ...
            await driveStraight(robutek, gyro, gyroZOffset, 5000, currentSpeed, EMERGENCY_BUTTON_PIN, angleState, leds, emergencyStop, () => emergencyLatched, async () => {
